...
const OIDMap = struct {
    const map:[21]OIDEntry = [_]OIDEntry{
        OIDEntry{ .oid = "2.5.4.3", .display_name = "CN", },
        OIDEntry{ .oid = "2.5.4.5", .display_name = "S/N", },
        OIDEntry{ .oid = "2.5.4.6", .display_name = "C", },
        OIDEntry{ .oid = "2.5.4.7", .display_name = "L", },
        OIDEntry{ .oid = "2.5.4.8", .display_name = "ST", },
        OIDEntry{ .oid = "2.5.4.10", .display_name = "O", },
        OIDEntry{ .oid = "2.5.4.15", .display_name = "businessCategory", },
        OIDEntry{ .oid = "1.3.6.1.4.1.311.60.2.1.2", .display_name = "jurisdictionST", },
        OIDEntry{ .oid = "1.3.6.1.4.1.311.60.2.1.3", .display_name = "jurisdictionC", },
        OIDEntry{ .oid = "1.2.840.113549.1.1.1", .display_name = "rsaEncryption", },
        OIDEntry{ .oid = "1.2.840.113549.1.1.11", .display_name = "sha256WithRSAEncryption", },
        OIDEntry{ .oid = "2.5.29.35", .display_name = "authorityKeyIdentifier", },
        OIDEntry{ .oid = "1.3.6.1.5.5.7.1.1", .display_name = "authorityInfoAccess", },
        OIDEntry{ .oid = "2.5.29.17", .display_name = "subjectAltName", },
        OIDEntry{ .oid = "2.5.29.32", .display_name = "certificatePolicies", },
        OIDEntry{ .oid = "2.5.29.37", .display_name = "extKeyUsage", },
        OIDEntry{ .oid = "2.5.29.31", .display_name = "cRLDistributionPoints", },
        OIDEntry{ .oid = "2.5.29.14", .display_name = "subjectKeyIdentifier", },
        OIDEntry{ .oid = "2.5.29.15", .display_name = "keyUsage", },
        OIDEntry{ .oid = "1.3.6.1.4.1.11129.2.4.2", .display_name = "extendedValidationCertificates", },
        OIDEntry{ .oid = "2.5.29.19", .display_name = "basicConstraints", },
    };
...
const Time = struct {
    ...
    pub fn writeToBuf(self: Self, out: []u8) !usize {
        ...
        try std.fmt.format(stream.writer(), "{d:0>2}-{d:0>2}-{d:0>2}-{d:0>2}:{d:0>2}:{d:0>2}{s}{d:0>2}:{d:0>2}", 
        .{self.year, self.month, self.day, self.hour, self.minute, self.second, plus_s, self.t_hour, self.t_minute});
