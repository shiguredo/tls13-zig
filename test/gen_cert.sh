...
openssl req -x509 -nodes -days 365 -subj '/C=JP/ST=Kyoto/L=Kyoto/CN=localhost' -newkey ec:<(openssl ecparam -name prime256v1) -nodes -sha256 -keyout key.pem -out cert.pem
